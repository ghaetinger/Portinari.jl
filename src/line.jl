...
using AbstractPlutoDingetjes, HypertextLiteral, Parameters, PlutoUI, PlutoLinks
...
@skip_as_script begin
	const D3 = @ingredients("./d3_abstractions.jl")
	const LinearScale = @ingredients("./linear_scale.jl").LinearScale
end
...
# ╔═╡ fedb33a5-3978-4c86-9a53-eecac8266518
@skip_as_script const D3Canvas = @ingredients("./canvas.jl").D3Canvas
